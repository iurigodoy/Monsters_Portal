				  ...
				  <div class="col-xs-6">
				 	<div class="panel panel-default">
					  ...
					  <a href="#paypal" data-toggle="collapse" data-parent="#accordion_pay" data-target="#collapse3">
						<div class="panel-heading">
							<input type="image" src="https://stc.pagseguro.uol.com.br/pagseguro/i/logos/logo-lg.png?v=0.2.4" name="submit" alt="Pague com PagSeguro - é rápido, grátis e seguro!" />
						</div>
					  </a>
