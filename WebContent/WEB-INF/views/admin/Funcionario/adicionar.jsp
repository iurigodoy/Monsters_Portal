                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
						<input name="cidade_fun" type="text" class="form-control" placeholder="Município" title="Município">
                      </div>
                      <div class="col-md-9 col-sm-12 col-xs-12 form-group">
						<input name="endereco_fun" type="text" class="form-control" placeholder="Endereço" title="Endereço">
                      </div>
                      <div class="col-md-3 col-sm-12 col-xs-12 form-group">
						<input name="numero_fun" type="text" class="form-control" placeholder="Nº" title="Nº">
                      </div>
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
