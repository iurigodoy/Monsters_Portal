...
<c:import url="../Header.jsp" />
            ...
            <ul>
              <li class="red">N�O H� UPLOAD DE IMAGENS</li>
            </ul>
			...
			<div class="row">
              <div class="col-md-8 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-user"></i> Funcion�rios</h2>
              ...
              <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        <input type="text" name="login_fun" class="form-control has-feedback-left" placeholder="Usu�rio" title="Login" value="${ fun.login_fun }">
	...
	<div class="modal-content">
	  <form action="<c:url value="UpdateFuncionario"/>" method="POST" class="form-horizontal form-label-left input_mask">
		...
		<div class="modal-header">
	      ...
	      <h4 class="modal-title" id="myModalLabel">Funcion�rio</h4>
	    </div>
