                  	...
                  	<div id="ajax-content-table">
                 		<table id="datatable-pt_br-responsivo" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
	                      ...
	                      <tbody>
					  		...
					  		<c:if test="${ not func.deleted }">
	                      	  <tr id="tr_${ func.id_funcionario }" data-history="1">
	                      	  	...
	                      	  	<td>
	                      	  	  <div class="edition-buttons" id="edition-buttons_${ func.id_funcionario }">
					                  <button type="button" data-id="${ func.id_funcionario }" class="btn btn-primary btn-xs Modal"
					  		...
					  		<c:if test="${ func.deleted }">
	                      	  <tr id="tr_${ func.id_funcionario }" data-history="0">
