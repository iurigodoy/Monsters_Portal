...
<c:import url="../Header.jsp" />
          ...
          <div class="row tile_count">
			...
			<c:forEach var="cliente" items="${clientes}">${cliente}</c:forEach>
              ...
              <span class="count_bottom"><i class="green">0% </i> Na última semana</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-external-link-square"></i> Visitantes</span>
              <div class="count green">0</div>
              <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>0% </i> Na última semana</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title">Cliente 1 Título</a>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title">Fornecedor 1 Título</a>
      ...
      $(document).ready(function() {
        ...
        var optionSet1 = {
          ...
          ranges: {
            ...
            'No Mês': [moment().startOf('month'), moment().endOf('month')],
