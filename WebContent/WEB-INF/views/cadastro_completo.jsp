...
<jsp:useBean id="cliente" class="br.com.monster.portal.model.Cliente"></jsp:useBean>
				...
				<div class="row">
					  <div class="col-md-12 col-sm-12 col-xs-12 form-group">
						<input type="text" name="nome_cli" class="form-control" placeholder="Nome" title="Nome" value="${ cliente.nome_cli }" required>
					  </div>
				</div>

				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12 form-group">
					  <input type="text" name="cpf_cli" class="form-control" placeholder="CPF" title="CPF" value="${ cliente.cpf_cli }" required>
					</div>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12 form-group">
					    ...
					    <label class="radio-inline">
					      <input type="radio" name="sexo_cli" value="1" required> Masculino
					    </label>
					    <label class="radio-inline">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-6 form-group">
					  <input type="text" name="cep_cli" class="form-control" placeholder="CEP" title="CEP" value="${ cliente.cep_cli }" required>
							  	  <a href="http://m.correios.com.br/movel/buscaCepConfirma.do" target="blank">Não sei meu CEP</a>
					</div>

				<div class="col-md-6 col-sm-6 col-xs-6 form-group">
				  <select name="estado_cli" class="form-control" title="Estado" required>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12 form-group">
					  <input type="text" name="cidade_cli" class="form-control" placeholder="Cidade" title="Cidade" value="${ cliente.cidade_cli }" required>
					</div>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12 form-group">
					  <input type="text" name="endereco_cli" class="form-control" placeholder="Endereco" title="Endereco" value="${ cliente.endereco_cli }" required>
					</div>
				</div>

				<div class="row">
					<div class="col-md-3 col-sm-4 col-xs-4 form-group">
					  <input type="text" name="numero_cli" class="form-control" placeholder="Numero" title="Numero" value="${ cliente.numero_cli }" required>
					</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12 form-group">
					  <input type="text" name="residencial_cli" class="form-control has-feedback-left" placeholder="Telefone Residencial" title="Telefone Residencial" value="${ cliente.residencial_cli }" required>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12 form-group">
					  <input type="text" name="email_cli" class="form-control has-feedback-left" placeholder="Email" title="Email" value="${ cliente.email_cli }" required>
					  <span class="form-control-feedback left" aria-hidden="true"><i class="fa fa-envelope-o"></i></span>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 form-group">
					  <input type="password" name="senha_cli" class="form-control has-feedback-left" placeholder="Senha" title="Senha" value="${ cliente.senha_cli }" required>
